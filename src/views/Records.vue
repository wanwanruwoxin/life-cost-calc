...
<template>
  <div class="w-full max-w-md mx-auto p-4">
      ...
      <QCardSection class="pt-0">
        ...
        <div v-else class="space-y-4">
          <div v-for="record in records" :key="record.id"
            ...
            <div class="ml-4">
              <QBtn icon="delete" color="negative" flat round @click="deleteRecord(record.id)" class="hover:bg-red-50">
    ...
    <div class="fixed bottom-6 right-6">
      <QBtn icon="add" color="primary" fab class="shadow-lg" @click="$router.push('/calculator')">
