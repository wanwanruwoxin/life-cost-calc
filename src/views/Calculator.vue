    ...
    <div class="w-full max-w-150">
      ...
      <QCard class="rounded-4 shadow-lg backdrop-blur-sm bg-white/95 mb-8" flat bordered>
        ...
        <QCardSection class="pt-0">
          ...
          <div class="p-4 bg-gray-50 rounded-3 border border-gray-200 mt-4">
      ...
      <Transition name="slide-up" appear>
        <QCard v-if="showResult" class="rounded-4 shadow-lg backdrop-blur-sm bg-white/95" flat bordered>
          <QCardSection class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-t-4 border-b border-indigo-100">
            <div class="text-lg font-medium flex items-center">
          ...
          <QCardSection class="pt-0">
            <div class="flex flex-col md:flex-row gap-4">
              <div class="flex items-center p-5 rounded-3 transition-all duration-300 border border-gray-200 bg-gradient-to-br from-cyan-50 to-blue-100 hover:-translate-y-0.5 hover:shadow-md">
                <QIcon name="calendar_month" size="md" class="mr-4 text-indigo-500" />
                <div class="flex-1">
                  <div class="text-3.5 text-slate-600 mb-1 font-medium">每月支出</div>
                  <div class="text-6 font-bold text-slate-800">{{ formatCurrency(priceCalcResult.monthly) }}</div>
                </div>
              </div>
              
              <div class="flex items-center p-5 rounded-3 transition-all duration-300 border border-gray-200 bg-gradient-to-br from-purple-50 to-pink-100 hover:-translate-y-0.5 hover:shadow-md">
                <QIcon name="calendar_today" size="md" class="mr-4 text-indigo-500" />
                <div class="flex-1">
                  <div class="text-3.5 text-slate-600 mb-1 font-medium">每年支出</div>
                  <div class="text-6 font-bold text-slate-800">{{ formatCurrency(priceCalcResult.yearly) }}</div>
                </div>
              </div>
            </div>
            
            <div v-if="text" class="flex items-center p-3 px-4 bg-gray-50 rounded-2 border-l-4 border-indigo-500 mt-4">
