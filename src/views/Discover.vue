  ...
  <QPage class="bg-gradient-to-br from-gray-50 to-blue-100 min-h-screen p-4 pb-20">
    <div class="w-full max-w-md mx-auto">
      ...
      <div class="grid grid-cols-2 gap-4 mb-8">
        ...
        >
          <QCardSection class="p-4 text-center relative">
            ...
            <h3 class="text-sm font-semibold text-gray-800 mb-2">{{ feature.title }}</h3>
      ...
      <QCard class="rounded-3 shadow-md mb-6">
        <QCardSection class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-t-3 border-b border-indigo-100">
        ...
        <QCardSection class="p-0">
          <QList>
            ...
            >
              ...
              <QItemSection>
                <QItemLabel class="font-medium text-gray-800">{{ update.title }}</QItemLabel>
                <QItemLabel caption class="text-gray-600 text-xs mt-1">{{ update.description }}</QItemLabel>
                <QItemLabel caption class="text-gray-400 text-xs mt-1">{{ update.date }}</QItemLabel>
              </QItemSection>
            </QItem>
          </QList>
        </QCardSection>
